 ...
 * @author bsame
 */
public class SlidingLanguageTooggle extends JToggleButton{
    ...
    private final String[] languages = {"Indonesia", "Inggris", "Jepang"};
    private final String[] langcodes = {"id", "en", "jpn"};
    

    public SlidingLanguageTooggle(){
        super();
    ...
    public String setSelectedLanguageIndexByString() {
